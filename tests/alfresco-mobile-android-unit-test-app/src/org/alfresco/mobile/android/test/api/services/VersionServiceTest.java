...
public class VersionServiceTest extends AlfrescoSDKTestCase
{
    ...
    {
        // Create Session
        // HashMap<String, Serializable> parameters = new HashMap<String,
        // Serializable>();
        // parameters.put(SessionSettings.BINDING_URL,
    ...
    private void increaseVersionNumber(Document doc, int versionNumber)
    {
        ...
        //Use cmissession because it's impossible to have a common behaviour with 3.4 and 4.
        ...
        for (int i = 0; i < versionNumber; i++)
        {
                ...
                org.apache.chemistry.opencmis.client.api.Document cmisDocpwc = (org.apache.chemistry.opencmis.client.api.Document) cmisSession.getObject(idpwc);
                iddoc = cmisDocpwc.checkIn(false, null, new ContentStreamImpl("test.txt", "plain/txt", "abc"),
                        "V:" + versionNumber);
