...
public interface SearchService
{
     ...
     *             during the process.
     */
    public PagingResult<Node> search(String statement, SearchLanguage language, ListingContext listingContext) throws AlfrescoServiceException;
     ...
     *             during the process.
     */
    public PagingResult<Node> keywordSearch(String keywords, KeywordSearchOptions options, ListingContext listingContext) throws AlfrescoServiceException;
