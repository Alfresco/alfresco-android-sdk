...
public class RepositoryInfoImpl implements RepositoryInfo {
     ...
     * @param rootNode 
     */
    public RepositoryInfoImpl(org.apache.chemistry.opencmis.commons.data.RepositoryInfo repositoryInfo)
    {
    ...
    public Integer getMajorVersion(){
        return InfoHelper.getVersion(getVersion(), 0);
    }
    ...
    public Integer getMinorVersion(){
        return InfoHelper.getVersion(getVersion(), 1);
    }
    ...
    public Integer getMaintenanceVersion(){
        int separator =  InfoHelper.getVersionString(getVersion(), 2).indexOf(' ');
        return Integer.parseInt(InfoHelper.getVersionString(getVersion(), 2).substring(0, separator));
    }
    ...
    public String getBuildNumber(){
        int separator =  InfoHelper.getVersionString(getVersion(), 2).indexOf(' ');
        return InfoHelper.getVersionString(getVersion(), 2).substring(separator);
    }
    
    /**
     * Returns Community or Enterprise if it's an alfresco Repository.
     * Returns product name if it's a CMIS server.
    ...
    public RepositoryCapabilities getCapabilities()
    {
        if (capabilities == null)
            capabilities = new RepositoryCapabilitiesImpl(this);
        return capabilities;
    }
    
    public org.apache.chemistry.opencmis.commons.data.RepositoryCapabilities getCmisCapabilities(){
        return repositoryInfo.getCapabilities();
    }
}
