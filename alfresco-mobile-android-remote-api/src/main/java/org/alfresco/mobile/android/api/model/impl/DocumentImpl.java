...
public class DocumentImpl extends NodeImpl implements Document
{
    ...
    /**
     * @return Returns the content stream length or -1 if the document has no content
     */
    ...
    /**
     * @return Returns the content stream MIME type or null if the document has no
     * content
     */
    ...
    {
        //If no versionlabel aspect on it, default 1.0 ? Incompatible if CMIS only
