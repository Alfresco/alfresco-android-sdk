...
public interface PersonService
{
     ...
     * @return  Returns a Person object representing the user with the given username.
    ...
    /**
     * @param person
     * @return Returns a ContentFile object representing the avatar of the given person, null is returned if the person does not have an avatar.
     * @throws AlfrescoServiceException : if network or internal problems occur
     *             during the process.
     */
