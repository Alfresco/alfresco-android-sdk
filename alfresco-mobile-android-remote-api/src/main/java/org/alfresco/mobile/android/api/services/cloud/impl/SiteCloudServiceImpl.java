 ...
 */
public class SiteCloudServiceImpl extends AbstractSiteServiceImpl
{
     ...
     */
    public SiteCloudServiceImpl(CloudSession repositorySession)
    {
    ...
    protected PagingResult<Site> computeSites(UrlBuilder url, boolean isAllSite) throws AlfrescoServiceException
    {
        ...
        return new PagingResult<Site>(result, response.getHasMoreItems(), response.getSize());
