...
public class NodeImpl implements Node
{
    ...
    /**
     * @return Returns the title of this Node public String getTitle() { if
     *         (hasAspect(ContentModel.ASPECT_TITLED) &&
     *         getProperty(ContentModel.PROP_TITLE) != null) return (String)
     *         getProperty(ContentModel.PROP_TITLE).getValue(); else return
     *         null; }
     */
    ...
    public Property getProperty(String name)
    {
        ...
        // if necessary.
        if (CMISMapping.ALFRESCO_TO_CMIS.containsKey(name)) name = CMISMapping.ALFRESCO_TO_CMIS.get(name);
        return getProp(name);
    }
    ...
    {
        if (!aspectName.startsWith(CMISMapping.CMISPREFIX_ASPECTS))
            aspectName = CMISMapping.CMISPREFIX_ASPECTS + aspectName;
        if (object != null)
        {
