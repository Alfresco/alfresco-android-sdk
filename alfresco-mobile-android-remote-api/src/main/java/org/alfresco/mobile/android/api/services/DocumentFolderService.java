...
public interface DocumentFolderService
{
     ...
     *             during the process.
     */
    public Document setContent(Document document, ContentFile file) throws AlfrescoServiceException;
     ...
     *             during the process.
     */
    public ContentFile downloadContent(Document document) throws AlfrescoServiceException;
    public ContentStream downloadContentStream(Document document) throws AlfrescoServiceException;
