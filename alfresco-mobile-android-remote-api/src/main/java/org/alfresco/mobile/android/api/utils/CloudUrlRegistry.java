...
public class CloudUrlRegistry
{
    ...
    public static final String BINDING_CMISATOM = "/alfresco/a/-default-/public/cmis/versions/1/atom";
    
    // ///////////////////////////////////////////////////////////////////////////////
    // CLOUD ACCOUNT
    // //////////////////////////////////////////////////////////////////////////////
    
    // TODO Create list of cloud prefix available
    public static final String PREFIX_TEST_CLOUD = "http://devapis.alfresco.com";

    public static final String CLOUD_TEST_ATOMPUB_URL = "http://devapis.alfresco.com"
            + CloudUrlRegistry.BINDING_CMISATOM;
    
    public static final String CLOUD_SERVICE_BINDING = "/alfresco/service";

    public static final String URL_CLOUD_SIGN_UP = "/internal/cloud/accounts/signupqueue";

    
    public static String getCloudSignupUrl(String baseUrl)
    {
        return new StringBuilder(baseUrl).append(CLOUD_SERVICE_BINDING).append(URL_CLOUD_SIGN_UP).toString();
    }
    ...
    private static StringBuilder createPrefix(CloudSession session, String networkIdentifier)
    {
        ...
        else if (session.getNetwork() != null) sb.append(session.getNetwork().getIdentifier());
