 ...
 */
public class CommentCloudServiceImpl extends AbstractCommentService
{
     ...
     */
    public CommentCloudServiceImpl(CloudSession repositorySession)
    {
    ...
    protected PagingResult<Comment> computeComment(UrlBuilder url)
    {
        ...
        return new PagingResult<Comment>(result, response.getHasMoreItems(), response.getSize());
    }
}
