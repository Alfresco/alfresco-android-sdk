...
public interface TaggingService
{
     ...
     *             during the process.
     */
    public List<String> getTags(Node node)  throws AlfrescoServiceException;;
     ...
     *             during the process.
     */
    public PagingResult<String> getTags(Node node, ListingContext listingContext)  throws AlfrescoServiceException;;
