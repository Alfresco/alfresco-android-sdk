...
/**
 * Error raises when an exception occurs during the connexion to a specific repository. <br/>
...
public class AlfrescoConnectionException extends AlfrescoException
{
    ...
    public static final String EXCEPTION_NAME = "AlfrescoConnexionException";
