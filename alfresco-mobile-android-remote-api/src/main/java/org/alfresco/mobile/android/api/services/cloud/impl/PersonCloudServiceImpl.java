...
import org.alfresco.mobile.android.api.services.impl.DocumentFolderServiceImpl;
 ...
 */
public class PersonCloudServiceImpl extends AbstractPersonService
{
     ...
     */
    public PersonCloudServiceImpl(AlfrescoSession repositorySession)
    {
    ...
    public ContentStream getAvatarStream(String username) throws AlfrescoServiceException
    {
        try
        {
            ...
            ContentStream st = ((DocumentFolderServiceImpl)session.getServiceRegistry().getDocumentFolderService()).downloadContentStream(person.getAvatarIdentifier());
            return st;
        }
        catch (Throwable e)
        {
