 ...
 */
public class TaggingServiceImpl extends AlfrescoService implements TaggingService
{
     ...
     */
    public TaggingServiceImpl(RepositorySession repositorySession)
    {
            ...
            throws AlfrescoServiceException, JSONException
    {
        ...
        return new PagingResult<String>(tags, hasMoreItems, results.length());
    }

    private PagingResult<String> computeSimpleTag(UrlBuilder url, ListingContext listingContext)
    {
        HttpUtils.Response resp = read(url);
        String resultsString = JsonUtils.convertStreamToString(resp.getStream());
        List<String> tags = new ArrayList<String>();
        ...
        return new PagingResult<String>(tags, hasMoreItems, totalItems);
    }
}
