...
public interface ActivityStreamService
{
     ...
     *             during the process.
     */
     List<ActivityEntry> getActivityStream() throws AlfrescoServiceException;
     ...
     *             during the process.
     */
     PagingResult<ActivityEntry> getActivityStream(ListingContext listingContext) throws AlfrescoServiceException;
     ...
     */
     List<ActivityEntry> getActivityStream(String personIdentifier) throws AlfrescoServiceException;
     ...
     *             or internal problems occur during the process.
     */
     List<ActivityEntry> getSiteActivityStream(String siteName) throws AlfrescoServiceException;
