...
public class BrowserMySitesFragment extends SitesFragment
{
    
    public static final String TAG = "BrowserMySitesFragment";

    public BrowserMySitesFragment()
    {
    }
    
    public static BrowserMySitesFragment newInstance(String username)
    {
        BrowserMySitesFragment bf = new BrowserMySitesFragment();
        ListingContext lc = new ListingContext();
        lc.setSortProperty(Sorting.NAME);
        lc.setIsSortAscending(true);
        Bundle b = createBundleArgs(username);
    ...
    public void onStart()
    {
        UIUtils.setFragmentTitle(getActivity(), R.string.select_my_sites_title);
        super.onStart();
    }
